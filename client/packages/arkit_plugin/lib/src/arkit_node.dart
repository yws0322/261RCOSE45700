...
class ARKitNode {
  ...
  /// Category mask applied to the node (and, for container nodes such as
  /// glTF models, the whole node hierarchy). A light illuminates this node
  /// only when `light.categoryBitMask & node.categoryBitMask != 0`,
  /// which enables per-object lighting.
  /// When null the SceneKit default (1) is kept.
