...
class ARKitLight {
  ...
  /// Restricts which nodes this light illuminates: a node is lit only when
  /// `light.categoryBitMask & node.categoryBitMask != 0`.
  /// When null the SceneKit default (all bits set) is kept, i.e. the light
  /// affects every node.
